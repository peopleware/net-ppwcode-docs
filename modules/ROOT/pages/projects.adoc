...
`PPWCode.Vernacular.NHibernate.IV`::
- Library with base classes and interfaces.
- Support for recent .NET SDKs.

`PPWCode.Vernacular.EntityFrameworkCore.I`::
- Library with base classes and interfaces.
- Support for recent .NET SDKs.
...
`PPWCode.Vernacular.RequestContext.I`::
- Library with base classes and interfaces.
- Support for recent .NET SDKs.

`PPWCode.Vernacular.HistoryEvent.I`::
- Library with base classes and interfaces.
- Support for recent .NET SDKs.
...
`PPWCode.AspNetCore.API.I`::
- Library with base classes and interfaces for the `API` part of a REST API solution.
- Support for recent .NET SDKs.

`PPWCode.AspNetCore.Server.I`::
- Library with base classes and interfaces for the `Server` part of a REST API solution.
- Support for recent .NET SDKs.

`PPWCode.AspNetCore.Host.I`::
- Library with base classes and interfaces for the `Host` part of a REST API solution.
- Support for recent .NET SDKs.

`PPWCode.NServiceBus.Host.I`::
- Library with base classes and interfaces for the `Host` part of a messaging solution.
- Support for recent .NET SDKs.
